...
def run_single_case(case_data):
    ...
    rtol = case_data.get("rtol", 8e-2)
    atol = case_data.get("atol", 8e-2)
...
def test_rms_norm_qwen3_vl_8b_instruct_unredacted_max():
...
if __name__ == "__main__":
    test_rms_norm_qwen3_vl_8b_instruct_unredacted_max()