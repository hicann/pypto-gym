...
# -----------------------------------------------------------------------------------------------------------
"""Single-op precision test for the Qwen3.6-27B gated_delta_rule fused kernel.

Compares PyPTO ``gated_delta_rule_wrapper`` against a pure-torch reference at
the real shapes of Qwen3.6-27B inference (see ``test_cases.json``).
...
Run::
    ...
    cd <repo_root>
    pytest tests/ops/qwen3_6_27b/test_gated_delta_rule_qwen3_6_27b.py
    # or, for the [PRECISION_PASS] marker on NPU:
    python3 tests/ops/qwen3_6_27b/test_gated_delta_rule_qwen3_6_27b.py
"""
import json
import logging
import os
...
def _run_chunk_case(case, device):
    ...
    from qwen3_6_27b.gated_delta_rule.gated_delta_rule_impl import gated_delta_rule_wrapper
