...
# -----------------------------------------------------------------------------------------------------------
"""ACLGraph / torch.library registration test for the Qwen3.6-27B gated_delta_rule kernel.

Asserts the registered op ``pypto::gated_delta_rule_qwen3_6`` (Meta + NPU) is:
...
Run::
    ...
    pytest tests/ops/qwen3_6_27b/test_gated_delta_rule_aclgraph_qwen3_6_27b.py
    # or, for the [PRECISION_PASS] marker on NPU:
    python3 tests/ops/qwen3_6_27b/test_gated_delta_rule_aclgraph_qwen3_6_27b.py
"""
import logging
import os
import sys
...
from qwen3_6_27b.gated_delta_rule.gated_delta_rule_impl import (  # noqa: E402
...
def test_registered_op_matches_wrapper(npu_device):
    ...
    logging.info("[aclgraph] registered pypto::gated_delta_rule_qwen3_6 == wrapper (bit-identical)")
...
def test_meta_shape_inference():
    ...
    with FakeTensorMode():
        ...
        out, st = torch.ops.pypto.gated_delta_rule_qwen3_6(q, k, v, g, beta, None, True)
    ...
    logging.info("[aclgraph meta] Meta shape inference OK for gated_delta_rule_qwen3_6")
