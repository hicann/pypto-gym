...
# Benchmark script for GutenOCR-3B
# Compares baseline vs PyPTO backend

set -e

MODEL_ID="GutenOCR-3B"
MODEL_PATH="/mnt/workspace/gitCode/cann/models/GutenOCR-3B"
INPUT_FILE="$(dirname $0)/sample_inputs.txt"
OUTPUT_LENGTH=100
SUMMARY_FILE="$(dirname $0)/benchmark_summary.txt"

echo "========================================"
echo "  GutenOCR-3B Performance Benchmark"
echo "========================================"
echo ""
echo "Model: ${MODEL_ID}"
...
python3 $(dirname $0)/ask_GutenOCR-3B.py \
