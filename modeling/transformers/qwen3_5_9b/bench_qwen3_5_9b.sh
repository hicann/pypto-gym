...
# E2E generation benchmark for Qwen3.5-9B (Ascend 910B3): whole-model greedy generation,
...
MODEL_ID="qwen3_5_9b"
MODEL_PATH="${MODEL_PATH:-/path/to/models/Qwen3.5-9B}"
DEVICE="${DEVICE:-0}"
