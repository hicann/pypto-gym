...
"""
Spatial-SSRL-3B 推理脚本
用法: python3 ask_Spatial-SSRL-3B.py [--prompt "问题"] [--device 卡号] [--model-path 路径]
...
parser.add_argument("--model-path", default="/mnt/workspace/gitCode/cann/models/Spatial-SSRL-3B", help="模型权重路径")
