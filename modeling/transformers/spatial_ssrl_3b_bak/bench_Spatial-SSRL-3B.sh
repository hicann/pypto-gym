...
# Benchmark script for Spatial-SSRL-3B
# Compares baseline vs PyPTO backend

set -e

MODEL_ID="Spatial-SSRL-3B"
MODEL_PATH="/mnt/workspace/gitCode/cann/models/Spatial-SSRL-3B"
INPUT_FILE="$(dirname $0)/sample_inputs.txt"
OUTPUT_LENGTH=100
SUMMARY_FILE="$(dirname $0)/benchmark_summary.txt"

echo "========================================"
echo "  Spatial-SSRL-3B Performance Benchmark"
echo "========================================"
echo ""
echo "Model: ${MODEL_ID}"
...
python3 $(dirname $0)/ask_Spatial-SSRL-3B.py \
