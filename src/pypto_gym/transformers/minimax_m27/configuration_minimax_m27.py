...
#
__all__ = ["MiniMaxM2Config", "MiniMaxM27Config"]
...
class MiniMaxM2Config(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            Vocabulary size of the MiniMaxM2 model. Defines the number of different tokens that can be
            represented by the `inputs_ids` passed when calling [`MiniMaxM2Model`]
...
# Alias used by the in-repo modeling (configuration_minimax_m27 import name).
MiniMaxM27Config = MiniMaxM2Config
