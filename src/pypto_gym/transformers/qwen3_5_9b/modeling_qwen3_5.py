...
class Qwen3_5GatedDeltaNet(nn.Module):
    ...
    def forward(
        ...
        if use_precomputed_states and seq_len == 1:
            ...
            # PyPTO injection (via sys.modules): swap in the fused chunk kernel
            # when enabled and shape constraints are met; otherwise fall back
            # to the original chunk function.
            import sys
            pto_kernels = sys.modules.get("qwen3_5_9b_pto_kernels")
...
class Qwen3_5TextModel(Qwen3_5PreTrainedModel):
    ...
    def _update_linear_attn_mask(self, attention_mask, past_key_values):
        ...
        has_cached_state = past_key_values is not None and past_key_values.has_previous_state()
        all_tokens_attended = attention_mask is not None and torch.all(attention_mask == 1)
        if has_cached_state or all_tokens_attended:
...
class Qwen3_5Model(Qwen3_5PreTrainedModel):
    ...
    def get_rope_index(
        ...
        **kwargs,
        ...
        - Since Qwen3.5 use timestamps to seperate videos, like <t1> <vision_start>
        <frame1> <vision_end> <t2> <vision_start> <frame2> <vision_end>, the
        video_grid_thw should also be split too.
    ...
    def _expand_inputs_for_generation(
        ...
        **model_kwargs,
        ...
        def _expand_dict_for_generation_visual(dict_to_expand):
            ...
            # but Qwen3_5 append vision_start to each frame of each video, so we need
