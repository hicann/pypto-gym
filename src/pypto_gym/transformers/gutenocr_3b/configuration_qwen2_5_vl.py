...
# -----------------------------------------------------------------------------------------------------------
# Based on transformers 5.6.0 qwen2_5_vl/configuration_qwen2_5_vl.py
# Modified for GutenOCR-3B with PTO support
# -----------------------------------------------------------------------------------------------------------
...
@auto_docstring(checkpoint="Qwen/Qwen2-VL-7B-Instruct")
@strict
class GutenOcr3BVLVisionConfig(Qwen2_5_VLVisionConfig):
    """GutenOCR-3B Vision config (subclassed for custom model_type)."""

    model_type = "gutenocr_3b_vl_vision"
...
@auto_docstring(checkpoint="Qwen/Qwen2-VL-7B-Instruct")
@strict
class GutenOcr3BVLTextConfig(Qwen2_5_VLTextConfig):
    """GutenOCR-3B Text config (subclassed for custom model_type)."""

    model_type = "gutenocr_3b_vl_text"
...
@auto_docstring(checkpoint="Qwen/Qwen2-VL-7B-Instruct")
@strict
class GutenOcr3BVLConfig(Qwen2_5_VLConfig):
    r"""
    GutenOCR-3B VL configuration - subclass of Qwen2_5_VLConfig with custom
    model_type and sub-configs for GutenOCR-specific class names.
