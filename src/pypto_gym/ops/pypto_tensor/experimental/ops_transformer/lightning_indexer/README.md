...
```bash
cd src/pypto_gym/ops/pypto_tensor/experimental/ops_transformer/lightning_indexer
...
```
src/pypto_gym/ops/pypto_tensor/experimental/ops_transformer/lightning_indexer/
