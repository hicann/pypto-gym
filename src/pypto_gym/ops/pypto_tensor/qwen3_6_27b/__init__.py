...
- 与 Qwen3.5-9B 共享相同的 kernel 实现，但通过独立的 sys.modules 命名空间 (qwen3_6_27b_pto_kernels) 支持 27B 模型的特定 shape 和并行策略

应用场景：
- Qwen3.6-27B 模型的 prefill 推理加速，通过 sys.modules 注入 qwen3_6_27b_pto_kernels 模块
