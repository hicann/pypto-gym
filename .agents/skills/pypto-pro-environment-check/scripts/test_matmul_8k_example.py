...
# Shape: M=N=8192, K=128. KL0=64, KL1=128.
...
#
# Usage:
#     msprof --output=./ python3 test_matmul_perf_asw_8k_k128_dn_move_offset.py
...
def compute(a_l1_tile, a_mat_4_buffer, b_mat_4_buffer,  # noqa: G.FNM.03
            a_left_db, b_right_db, acc_db, a, b, out, i):
...
def matmul_example(
    ...
    with pl.section_cube():
        ...
        for i in pl.range(core_id, a.shape[0] // 128, num_cores):
            ...
            compute(a_l1_tile, a_mat_4_buffer, b_mat_4_buffer,
                    a_left_db, b_right_db, acc_db, a, b, out, i)
