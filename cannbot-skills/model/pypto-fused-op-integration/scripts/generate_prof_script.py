...
BASELINE_CMD="python3 ${{ASK_SCRIPT}} --model-path ${{MODEL_PATH}}"
BASELINE_CMD="${{BASELINE_CMD}} --sentence_file ${{INPUT_FILE}}"
BASELINE_CMD="${{BASELINE_CMD}} --output-length ${{OUTPUT_LENGTH}}"
PYPTO_CMD="${{BASELINE_CMD}} --use-pto"
