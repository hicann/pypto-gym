...
21. **Skill read timing** — Read a skill's SKILL.md only when a Stage SKILL.md explicitly directs you to. Skills live flat under `.opencode/skills/<skill-id>/`; read the named skill's SKILL.md directly. Do not pre-read all skills. Token cost is not an excuse to skip reading a skill when directed.
