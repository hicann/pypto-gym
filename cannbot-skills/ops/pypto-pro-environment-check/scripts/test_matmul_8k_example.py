...
"""ASW Matmul 8K-K128 smoke test using a two-layer K loop.

The shape is M=N=8192 and K=128; KL0=64 and KL1=128. One wide GM-to-L1
load feeds two L1-to-L0 sub-tile reads. For profiling, run this file through
``msprof --output=./ python3 test_matmul_8k_example.py``.
"""
