...
| Prefix-dependent scan | Ascend950PR_9579 | Historical report for both vector-unit dataflows; exact scan operation, dtype, shape and case matrix were not retained | Reported as built, compiled and bit-exact | The generator was not retained; performance figures are target-specific and are not reusable targets |
