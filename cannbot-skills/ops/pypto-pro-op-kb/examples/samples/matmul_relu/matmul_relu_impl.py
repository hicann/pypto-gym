...
# -----------------------------------------------------------------------------------------------------------
# Kernel 11 fuses a 64-by-64 FP32 matmul with ReLU using the kernel-5 handoff pattern.
import logging
...
def mm_relu(
    ...
    with pl.section_vector():
        ...
        pl.relu(tile_out, mm1_res)  # max(z, 0)
...
def test_mm_relu_gate_a():
    ...
    LOGGER.info(f"GATEA mm_relu 64x64 maxdiff={d:.3e}")
